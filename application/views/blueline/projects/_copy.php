...
<div class="form-group">
       ...
       <div class="input-group"> <div class="input-group-addon"><?php echo $core_settings->project_prefix;?></div> <?php } ?>
...
<div class="checkbox">
                           <label>
                            ...
                            <span class="lbl"> <?php echo $this->lang->line('application_calculate_progress');?> </span>
                          </label>
                          <script>
...
<div class="form-group">
                          <label for="phases"><?php echo $this->lang->line('application_phases');?> *</label>
...
<ul class="accesslist">
                        ...
                        <li>
                        <input name="tasks" class="checkbox" data-labelauty="<?php echo $this->lang->line('application_copy_tasks');?>" value="1" type="checkbox" checked="checked" />
                        </li>
</ul>
</div>
