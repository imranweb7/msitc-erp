...
<div class="form-group">
    <label for="name"><?=$this->lang->line('application_project_type_name');?> *</label>
    <input type="text" name="name" class="form-control" id="name"  value="<?php if(isset($project_type)){echo $project_type->name;} ?>" required/>
</div>

<div class="form-group">
    <label for="textfield"><?=$this->lang->line('application_project_type_description');?></label>
...
<div class="form-group">
    <label for="inactive"><?=$this->lang->line('application_project_type_status');?></label><br>
    <?php
    $options = array();
    $options['0'] = 'Yes';
    $options['1'] = 'No';
