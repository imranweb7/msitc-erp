<div class="col-sm-13  col-md-12 main">  
    ...
    <div class="row"> 
			<a href="<?php echo base_url()?>ctickets/create" class="btn btn-primary" data-toggle="mainmodal"><?php echo $this->lang->line('application_create_new_ticket');?></a>
	...
	<div class="row">
		...
		<div class="table-div">
		<table class="data-sorting table" id="ctickets" rel="<?php echo base_url()?>" cellspacing="0" cellpadding="0">
		<thead>
