...
<div class="form-group">
        <label for="client_id"><?php echo $this->lang->line('application_client');?></label>
        <?php $workers = array();
...
<div class="form-group">
        ...
        <input id="subject" type="text" name="subject" class="form-control" value="<?php echo $this->lang->line('application_notification_ticket_assign_subject');?>"  required/>
</div>    
<div class="form-group">
...
<ul class="accesslist">
<li> <input type="checkbox" class="checkbox" id="r_notify" name="notify" value="yes" data-labelauty="<?php echo $this->lang->line('application_notify_client');?>">  </li>
</ul>       
