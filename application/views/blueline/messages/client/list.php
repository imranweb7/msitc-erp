...
<li class="<?php if($filter){echo $filter;}else{echo $value->status."-dot";}?> hidden" data-link="<?php echo base_url()?>cmessages/view/<?php echo $value->id;?><?php if(isset($filter)){echo "/".$filter;} ?><?php if(isset($filter)){ if($filter == "Sent"){echo "/".$value->recipient;} } ?>">
