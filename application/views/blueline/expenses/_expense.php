...
<input id="id" type="hidden" name="id" value="<?php echo $expense->id;?>" />
<?php } ?>
 ...
 <div class="form-group">
  ...
  <div class="form-group">
        <label for="category"><?php echo $this->lang->line('application_category');?></label>
   ...
   <div class="form-group">
        <label for="terms"><?php echo $this->lang->line('application_description');?></label>
 ...
 <div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group">
                ...
                <label for="vat"><?php echo $this->lang->line('application_tax_included');?></label>
  ...
  <div class="form-group">
        <label for="project"><?php echo $this->lang->line('application_linked_to_project');?></label>
        <?php $options = array();
 ...
 <div class="form-group">
        <label for="type"><?php echo $this->lang->line('application_rebill');?></label>
        <?php $options = array();
                $options['0'] = $this->lang->line('application_no');
 ...
 <div class="form-group">
        <label for="reference"><?php echo $this->lang->line('application_receipt_reference');?></label>
        <input id="reference" type="text" name="reference" class="form-control"  value="<?php if(isset($expense)){echo $expense->reference;} ?>"  />
 </div>

 <div class="form-group">
                <label for="userfile"><?php echo $this->lang->line('application_attachment');?></label>
                <div>
 ...
 <div class="form-group">
        <label for="attachment_description"><?php echo $this->lang->line('application_attachment_description');?></label>
 ...
 <?php if(isset($expense->user->firstname)){ ?>
  <div class="form-group" style="font-size: 11px; margin: 23px 3px 3px;">
    <?php echo $this->lang->line('application_created_by')." ".$expense->user->firstname." ".$expense->user->lastname; ?>
 </div>
<?php }else{ ?>
<input id="user_id" type="hidden" name="user_id" value="<?php echo $this->user->id;?>" />
<?php    }?>
