...
<div class="top-background">
   <table width="100%" cellspacing="0" >
         ...
         <tr>
            <td style="vertical-align:top"><?php echo $estimate->company->name;?></td>
            <td class="right" style="vertical-align:top"></td>
        </tr> 
        <tr>
            <td style="vertical-align:top"><strong><?php if(isset($estimate->company->client->firstname)){ ?> <?php echo $estimate->company->client->firstname;?> <?php echo $estimate->company->client->lastname;?></strong><?php } ?></td>
            <td class="right" style="vertical-align:top"></td>
        </tr>
        <tr>
            <td style="vertical-align:top"><?php echo $estimate->company->address;?></td>
            <td class="right" style="vertical-align:top"></td>
        </tr>
        <tr>
            <td style="vertical-align:top"><?php echo $estimate->company->city;?>, <?php echo $estimate->company->zipcode;?></td>
            <td class="right" style="vertical-align:top"></td>
        </tr>
        <tr>
            <td style="vertical-align:top"><?php if($estimate->company->province != ""){?><?php echo $estimate->company->province;?><?php } ?></td>
            <td class="right" style="vertical-align:top"></td>
        </tr>
        <tr>
            <td style="vertical-align:top"><?php if($estimate->company->vat != ""){?><?php echo $this->lang->line('application_vat');?>: <?php echo $estimate->company->vat; ?><?php } ?></td>
            <td class="right" style="vertical-align:top"></td>
        </tr>
        <tr>
