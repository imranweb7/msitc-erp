...
<div class="top-background">
   <table width="100%" cellspacing="0" >
         ...
         <tr>
            ...
            <td class="right" style="vertical-align:top"><?php echo $invoice->company->name;?></td>
        </tr> 
        <tr>
            <td style="vertical-align:top"><?php echo $core_settings->invoice_contact;?></td>
            <td class="right" style="vertical-align:top"><strong><?php if(isset($invoice->company->client->firstname)){ ?> <?php echo $invoice->company->client->firstname;?> <?php echo $invoice->company->client->lastname;?></strong><?php } ?></td>
        </tr>
        <tr>
            <td style="vertical-align:top"><?php echo $core_settings->invoice_address;?></td>
            <td class="right" style="vertical-align:top"><?php echo $invoice->company->address;?></td>
        </tr>
        <tr>
            <td style="vertical-align:top"><?php echo $core_settings->invoice_city;?></td>
            <td class="right" style="vertical-align:top"><?php echo $invoice->company->city;?>, <?php echo $invoice->company->zipcode;?></td>
        </tr>
        <tr>
            <td style="vertical-align:top"></td>
            <td class="right" style="vertical-align:top"><?php if($invoice->company->province != ""){?><?php echo $invoice->company->province;?><?php } ?></td>
        </tr>
        <tr>
            <td style="vertical-align:top"></td>
            <td class="right" style="vertical-align:top"><?php if($invoice->company->vat != ""){?><?php echo $this->lang->line('application_vat');?>: <?php echo $invoice->company->vat; ?><?php } ?></td>
        </tr>
        <tr>
  ...
  <?php $i = 0; $sum = 0; $row=false; ?>
    ...
    <tr <?php if($row){?>class="even"<?php } ?>>
      <td>
        ...
        <span class="description"><?php echo  str_replace("&lt;br&gt;", "<br>", $invoice->invoice_has_items[$i]->description);?><span class="item-name">
      </td>
      <td class="center"><?php echo $invoice->invoice_has_items[$i]->amount;?></td>
