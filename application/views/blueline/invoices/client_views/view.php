		...
		<ul class="details col-xs-12 col-sm-6">
			<?php if(count($invoice_addresses) > 0){ foreach($invoice_addresses as $invoice_address){ ?>
				<li><span><?php echo $this->lang->line('application_company');?>:</span> <a href="#" class="label label-info"><?php echo $invoice_address->billing_company;?></a></li>
		...
		<tr class="payments">
			<td colspan="4" align="right"><?php echo $this->lang->line('application_payments_received');?></td>
			<td>- <?php echo display_money($invoice->paid);?></td>
		</tr>
		<tr class="active">
			<td colspan="4" align="right"><?php echo $this->lang->line('application_total_outstanding');?></td>
...
<div class=" col-md-12" align="right">
	...
	<div class="btn-group dropup">
	  ...
	  <?php if($core_settings->stripe == "1" && $core_settings->authorize_net == "0" && $sum != "0.00" && $invoice->status != "Paid" ){ ?>  
	    ...
	    <li><a id="pay_credit_card" data-toggle="mainmodal" href="<?php echo base_url()?>cinvoices/stripepay/<?php echo $invoice->id;?>/<?php echo $sumRest;?>"><i class="fa fa-credit-card" style="margin-right:5px"></i> <?php echo $this->lang->line('application_credit_card');?></a></li>
	  <?php } ?>

	  <?php if($core_settings->stripe == "0" && $core_settings->authorize_net == "1" && $sum != "0.00" && $invoice->status != "Paid" ){ ?>  
	    <li><a id="pay_credit_card" data-toggle="mainmodal" href="<?php echo base_url()?>cinvoices/authorizenet/<?php echo $invoice->id;?>/<?php echo $sumRest;?>"><i class="fa fa-credit-card" style="margin-right:5px"></i> <?php echo $this->lang->line('application_credit_card');?></a></li>
	  <?php } ?>
	  </ul>
	</div>
