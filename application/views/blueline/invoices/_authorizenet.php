...
<input type="hidden" name="invoice_id" value="<?= $invoices->id;?>">
        ...
        <div class="form-group">
        <label><?=$this->lang->line('application_expiration');?> (MM/YY)</label>
        <div class="row">
        ...
        <div class="form-group">
        <span class="help-block"><b><?=$this->lang->line('application_your_credit_card_will_be_charged_for');?> <?php echo display_money(sprintf("%01.2f", round($invoices->sum-$invoices->paid, 2))); ?> <?=$settings->authorize_currency;?></b></span>
        </div>
