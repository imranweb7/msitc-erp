				  ...
				  <div class="col-md-6">
					  ...
					  <div class="subcont" >
						  ...
						  if(!empty($estimate->shipping_lebel)){
							  ...
							  ?>
							  <br />
							  <a href="<?php echo base_url()?>cestimates/download/<?php echo $estimate->id;?>" class="btn btn-xs btn-success"><i class="icon-download icon-white"></i> <?php echo $this->lang->line('application_download');?></a>
...
<?php } ?>
		...
		<table class="table noclick" id="items" rel="<?php echo base_url()?>cinvoices/item" cellspacing="0" cellpadding="0">
		<thead>
