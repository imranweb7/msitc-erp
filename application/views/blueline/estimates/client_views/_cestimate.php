...
<div class="form-group">
    ...
    if(isset($estimate)){$country_selected = $estimate->shipping_country;}else{$country_selected = "";}
...
<div class="form-group">
    ...
    <input type="text" name="shipping_phone" class="form-control" id="shipping_phone"  value="<?php if(isset($estimate)){echo $estimate->shipping_phone;} ?>"/>
</div>
