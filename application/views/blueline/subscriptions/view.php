<div class="row">
        <div class="col-xs-12 col-sm-12">
			<a href="<?php echo base_url()?>subscriptions/update/<?php echo $subscription->id;?>/view" class="btn btn-primary" data-toggle="mainmodal"><i class="fa fa-edit visible-xs"></i><span class="hidden-xs"><?php echo $this->lang->line('application_edit_subscription');?></span></a>
			<a href="<?php echo base_url()?>subscriptions/item/<?php echo $subscription->id;?>" class="btn btn-primary" data-toggle="mainmodal"><i class="fa fa-plus visible-xs"></i><span class="hidden-xs"><?php echo $this->lang->line('application_add_item');?></span></a>
			...
			<a href="<?php echo base_url()?>subscriptions/create_invoice/<?php echo $subscription->id;?>" class="btn btn-primary"><i class="fa fa-file-o visible-xs"></i><span class="hidden-xs"><?php echo $this->lang->line('application_create_invoice');?></span></a>
			<?php } ?>
			<?php if($subscription->status != "Paid" && isset($subscription->company->name)){ ?><a href="<?php echo base_url()?>subscriptions/sendsubscription/<?php echo $subscription->id;?>" class="btn btn-primary"><i class="fa fa-envelope visible-xs"></i><span class="hidden-xs"><?php echo $this->lang->line('application_send_subscription_to_client');?></span></a><?php } ?>
		...
		<div class="row">
		<div class="col-xs-12 col-sm-12">
		<div class="table-head"><?php echo $this->lang->line('application_subscription_items');?> <span class="pull-right"><a href="<?php echo base_url()?>subscriptions/item/<?php echo $subscription->id;?>" class="btn btn-primary" data-toggle="mainmodal"><?php echo $this->lang->line('application_add_item');?></a></span></div>
		...
		<tr id="<?php echo $value->id;?>" >
			 <td class="option" width="8%" style="text-align: left;">
				        <button type="button" class="btn-option delete po" data-toggle="popover" data-placement="left" data-content="<a class='btn btn-danger po-delete ajax-silent' href='<?php echo base_url()?>subscriptions/item_delete/<?php echo $subscription->subscription_has_items[$i]->id;?>/<?php echo $subscription->id;?>'><?php echo $this->lang->line('application_yes_im_sure');?></a> <button class='btn po-close'><?php echo $this->lang->line('application_no');?></button> <input type='hidden' name='td-id' class='id' value='<?php echo $value->id;?>'>" data-original-title="<b><?php echo $this->lang->line('application_really_delete');?></b>"><i class="fa fa-times"></i></button>
				        <a href="<?php echo base_url()?>subscriptions/item_update/<?php echo $subscription->subscription_has_items[$i]->id;?>" class="btn-option" data-toggle="mainmodal"><i class="fa fa-cog"></i></a>
			       </td>
			<td ><?php echo $subscription->subscription_has_items[$i]->name;?></td>
			<td class="hidden-xs"><?php echo $subscription->subscription_has_items[$i]->description;?></td>
			<td class="hidden-xs" align="center"><?php echo $subscription->subscription_has_items[$i]->amount;?></td>
