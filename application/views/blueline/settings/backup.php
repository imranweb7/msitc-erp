...
<div class="col-md-9">
		...
		<div class="table-head"><?php echo $this->lang->line('application_database_backups');?> <span class="pull-right"><a href="mysql_restore" class="btn btn-primary " data-toggle="mainmodal"><i class="fa fa-upload"></i> <?php echo $this->lang->line('application_restore_database');?></a> <a href="<?php echo base_url()?>settings/mysql_backup" class="btn btn-primray"><i class="fa fa-download"></i> <?php echo $this->lang->line('application_backup_database');?></a></span></div>
		...
		<tr>
			...
			<td class="option" style="width:8%">
				<a class="btn-option tt" href="<?php echo base_url()?>settings/mysql_download/<?php echo $file?>" title="<?php echo $this->lang->line('application_download');?>"><i class="fa fa-download"></i></a>
			</td>
		</tr>
		...
		<tr>
			<td colspan="4"><?php echo $this->lang->line('application_no_backups');?></td>
		</tr> 
		<?php } ?>
	 	</table>
	 	</div>
