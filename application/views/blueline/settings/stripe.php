...
<div class="col-md-9">
		<div class="table-head">Stripe <?php echo $this->lang->line('application_settings');?></div>
		<div class="table-div">
		<?php   
...
<br>
            ...
            <input name="stripe" type="checkbox" class="checkbox" style="width:100%;" data-labelauty="<?php echo $this->lang->line('application_stripe_active');?>" value="1" <?php if($settings->stripe == "1"){ ?> checked="checked" <?php } ?>>

 </div>
<div class="form-group"><label><?php echo $this->lang->line('application_stripe_public_key');?></label>
			<input type="text" name="stripe_key" class="form-control" value="<?php echo $settings->stripe_key;?>">
</div>
<div class="form-group"><label><?php echo $this->lang->line('application_stripe_private_key');?></label>
			<input type="text" name="stripe_p_key" class="form-control" value="<?php echo $settings->stripe_p_key;?>">
</div>

<div class="form-group"><label><?php echo $this->lang->line('application_currency');?></label>
			<select name="stripe_currency" class="formcontrol chosen-select ">
			<?php if($settings->stripe_currency != ""){ ?><option value="<?php echo $settings->stripe_currency;?>" selected=""><?php echo $settings->stripe_currency;?></option><?php } ?>
...
<div class="form-group">
		...
		<div class="table-head">Authorize.net <?php echo $this->lang->line('application_settings');?></div>
		<div class="table-div">
		<?php   
...
<br>
            ...
            <input name="authorize_net" type="checkbox" class="checkbox" style="width:100%;" data-labelauty="<?php echo $this->lang->line('application_authorize_active');?>" value="1" <?php if($settings->authorize_net == "1"){ ?> checked="checked" <?php } ?>>

 </div>
<div class="form-group"><label><?php echo $this->lang->line('application_api_login_id');?></label>
			<input type="text" name="authorize_api_login_id" class="form-control" value="<?php echo $settings->authorize_api_login_id;?>">
</div>
<div class="form-group"><label><?php echo $this->lang->line('application_api_transaction_key');?></label>
			<input type="text" name="authorize_api_transaction_key" class="form-control" value="<?php echo $settings->authorize_api_transaction_key;?>">
</div>
<div class="form-group"><label><?php echo $this->lang->line('application_currency');?></label>

<select id="authorize_currency" name="authorize_currency" class="chosen-select">
												<option value="<?php echo $settings->authorize_currency;?>" selected=""><?php echo $settings->authorize_currency;?></option>
